...
CREATE TABLE `drug_info` (
  ...
  `status` int NOT NULL COMMENT '状态，0：正常，1：已删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='药品字典表';
...
INSERT INTO `drug_info` VALUES ('12', '苯甲胺', '2', '1', '100', '1', '0');
INSERT INTO `drug_info` VALUES ('13', '测试111', '2', '1', '1', '2', '0');
INSERT INTO `drug_info` VALUES ('14', '测试2', '1', '1', '1', '2', '0');
...
CREATE TABLE `drug_info_operation_log` (
  ...
  `create_time` timestamp NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='药品字典变更日志记录表';
...
INSERT INTO `drug_info_operation_log` VALUES ('6', '1', null, '{\"drugName\":\"苯甲胺\",\"drugTypeId\":1,\"id\":12,\"price\":100,\"productAddressId\":2,\"status\":0,\"unitId\":1}', '2022-11-16 19:56:59');
INSERT INTO `drug_info_operation_log` VALUES ('7', '1', null, '{\"drugName\":\"测试111\",\"drugTypeId\":2,\"id\":13,\"price\":1,\"productAddressId\":2,\"status\":0,\"unitId\":1}', '2022-11-16 19:59:34');
INSERT INTO `drug_info_operation_log` VALUES ('8', '1', null, '{\"drugName\":\"测试2\",\"drugTypeId\":2,\"id\":14,\"price\":1,\"productAddressId\":1,\"status\":0,\"unitId\":1}', '2022-11-16 20:02:23');
...
-- ----------------------------
INSERT INTO `outer_patient_login` VALUES ('23', '18257160371', '2022-11-20 21:39:41');
INSERT INTO `outer_patient_login` VALUES ('28', '18257160374', '2022-11-20 22:02:52');
INSERT INTO `outer_patient_login` VALUES ('29', '18257460372', '2022-11-21 09:42:42');
...
-- ----------------------------
-- Table structure for `patient_system_message`
-- ----------------------------
DROP TABLE IF EXISTS `patient_system_message`;
CREATE TABLE `patient_system_message` (
  `id` int NOT NULL AUTO_INCREMENT,
  `patient_id` int NOT NULL COMMENT '患者id',
  `system_message` varchar(255) DEFAULT NULL COMMENT '站内消息',
  `status` int DEFAULT NULL COMMENT '状态 0：新消息，1：已看过',
  `create_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '生成时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='病人站内信表';

-- ----------------------------
-- Records of patient_system_message
-- ----------------------------
INSERT INTO `patient_system_message` VALUES ('1', '23', 'Xxx，您好！本月话费可用余额，请及时充值，避免由于停机给您带来的不便！', '0', '2022-11-21 11:09:07');
...
INSERT INTO `sys_menu` VALUES ('91', '1', '挂号', '', '0', null, '&#xe638;', '1');
INSERT INTO `sys_menu` VALUES ('92', '91', '我的挂号', '../patient/register', '0', null, '&#xe632;', '1');
...
INSERT INTO `sys_role` VALUES ('6', '患者', '病人', '1');
...
INSERT INTO `sys_role_user` VALUES ('18', '6');
INSERT INTO `sys_role_user` VALUES ('17', '6');
INSERT INTO `sys_role_user` VALUES ('19', '6');
INSERT INTO `sys_role_user` VALUES ('20', '6');
INSERT INTO `sys_role_user` VALUES ('21', '6');
INSERT INTO `sys_role_user` VALUES ('22', '6');
INSERT INTO `sys_role_user` VALUES ('24', '6');
INSERT INTO `sys_role_user` VALUES ('25', '6');
INSERT INTO `sys_role_user` VALUES ('26', '6');
INSERT INTO `sys_role_user` VALUES ('27', '6');
INSERT INTO `sys_role_user` VALUES ('28', '6');
INSERT INTO `sys_role_user` VALUES ('29', '6');
INSERT INTO `sys_role_user` VALUES ('23', '6');
